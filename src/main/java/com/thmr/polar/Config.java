...
public class Config
{
	...
	public static Integer SPORT_ID_RUNNING = 1;
	public static Integer SPORT_ID_CYCLING = 2;
	public static Integer SPORT_ID_MOUNTAIN_BIKING = 5;
	public static Integer SPORT_ID_STRENGTH_TRAINING = 15;
	public static Integer SPORT_ID_OTHER_OUTDOOR = 16;
	public static Integer SPORT_ID_INDOOR_CYCLING = 18;
	public static Integer SPORT_ID_INLINE_SKATING = 29;
	public static Integer SPORT_ID_ROAD_CYCLING = 38;
}
